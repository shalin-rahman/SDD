# Viable product — complete execution playbook

**Status:** Planning complete — 2026-06-12  
**Audience:** Product, engineering, agents  
**Parent:** `plan/16-standard-viable-system.md` (roadmap) · **Gate:** `plan/16-product-ready-dod.md`  
**Feedback:** `docs/product/user-feedback-registry.md` (read before any product work)

This document is the **single execution index** for closing viable product gaps across API, web, mobile, modules, docs, and CI. Implementation order follows §4; slice cards in §5–§12 hold acceptance criteria.
...
| Backlog implementation | **~70%** task Done | `plan/03-task-backlog.md` |
...
| Platform service pages | **Wired** — thin tables, Account demo dump | `account.component.ts` |
| Admin/settings | **Wired** — toggle-heavy | Phase 12 partial items |
| Inventory module | API DoD v1; product v2 **open**; **W5** stock movements planned (C14) | `inventory-definition-of-done-v2.md`, `plan/20-standard-entity-rollout.md` §1.5 |
...
| **M5** | Viable platform demo | P17 service pages Demo+; CRM LEAD/CONTACT Demo+; P18 smoke green | M6 |
...
| D SDD questions | `16-standard-viable-system.md` §8 out-of-scope |
...
## 14. SDD § crosswalk (viable v1)

| SDD § | Viable v1 target | Sprint |
|-------|------------------|--------|
...
## 18. Explicit out of scope (viable v1)

Same as `16-standard-viable-system.md` §8 + registry §I: hot-install, PCI capture, layout designer UI, Grafana embed, new modules beyond inventory/CRM, multi-region SLA proof.
